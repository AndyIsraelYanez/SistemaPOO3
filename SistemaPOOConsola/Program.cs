...
namespace SistemaPOOConsola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            ...
            Console.WriteLine($"{tablet2.Resistencia(" Es resistente agua ")}");
            ...
            Console.WriteLine($"{tablet3.Resistencia(" Es resistente agua ")}");
            ...
            Console.WriteLine($"{smartphone1.Resistencia(" Es resistente agua ")}");
            ...
            Console.WriteLine($"{smartphone3.Resistencia(" Es resistente agua ")}");
            ...
            Console.WriteLine($"{smartphone4.Resistencia(" Es resistente agua ")}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{licuadora1.On()}");
            Console.WriteLine($"{licuadora1.Licuar(" Rápido ")}");
            Console.WriteLine($"{licuadora1.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{licuadora2.On()}");
            Console.WriteLine($"{licuadora2.Licuar(" Lentó ")}");
            Console.WriteLine($"{licuadora2.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{licuadora3.On()}");
            Console.WriteLine($"{licuadora3.Licuar(" Rápido ")}");
            Console.WriteLine($"{licuadora3.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{licuadora4.On()}");
            Console.WriteLine($"{licuadora4.Licuar(" Lentó ")}");
            Console.WriteLine($"{licuadora4.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{batidora1.On()}");
            Console.WriteLine($"{batidora1.Batir(" Normal ")}");
            Console.WriteLine($"{batidora1.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{batidora2.On()}");
            Console.WriteLine($"{batidora1.Batir(" Lento ")}");
            Console.WriteLine($"{batidora2.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{batidora3.On()}");
            Console.WriteLine($"{batidora1.Batir(" Rápido ")}");
            Console.WriteLine($"{batidora3.Off()}");
            ...
            Console.WriteLine($"Las Respectivas Funcionalidades del producto:");
            Console.WriteLine($"{batidora4.On()}");
            Console.WriteLine($"{batidora1.Batir(" Lento ")}");
            Console.WriteLine($"{batidora4.On()}");
            Console.BackgroundColor = ConsoleColor.Black;
